...
/** Low-level wrapper for `::fz_apply_table_hunt_options()`. */
/**
	Parse table hunt device options from an fz_options struct
	into an already initialised opts structure.
*/
FZ_FUNCTION void ll_fz_apply_table_hunt_options(::fz_table_hunt_options *opts, ::fz_options *options);
...
/**
	...
	the table.
*/
FZ_FUNCTION ::fz_stext_block *ll_fz_find_table_within_bounds(::fz_stext_page *page, ::fz_rect bounds, const ::fz_table_hunt_options *opts);
...
/**
	...
	limit.
*/
FZ_FUNCTION ::fz_stext_block *ll_fz_find_table_within_grid(::fz_stext_page *page, ::fz_stext_grid_positions *xpos, ::fz_stext_grid_positions *ypos, float limit, const ::fz_table_hunt_options *opts);

/** Low-level wrapper for `::fz_find_table_within_grid_dividers()`. */
FZ_FUNCTION ::fz_stext_block *ll_fz_find_table_within_grid_dividers(::fz_stext_page *page, const std::vector<fz_stext_grid_divider> &xs, const std::vector<fz_stext_grid_divider> &ys, float limit, ::fz_table_hunt_options *opts);

/** Low-level wrapper for `::fz_find_table_within_grid_floats()`. */
/** Swig-friendly wrapper for fz_find_table_within_grid(). */
FZ_FUNCTION ::fz_stext_block *ll_fz_find_table_within_grid_floats(::fz_stext_page *page, const std::vector<float> &xs, const std::vector<float> &ys, float limit, ::fz_table_hunt_options *opts);
...
/** Low-level wrapper for `::fz_init_table_hunt_options()`. */
FZ_FUNCTION void ll_fz_init_table_hunt_options(::fz_table_hunt_options *opts);
...
/** Low-level wrapper for `::fz_parse_table_hunt_options()`. */
/**
	...
	This initialises the opts structure.
*/
FZ_FUNCTION ::fz_table_hunt_options *ll_fz_parse_table_hunt_options(::fz_table_hunt_options *opts, const char *args);
...
This function has out-params. Python/C# wrappers look like:
	`ll_fz_propose_table_within_bounds(::fz_stext_page *page, ::fz_rect bounds, ::fz_stext_grid_positions **xposp, ::fz_stext_grid_positions **yposp, const ::fz_table_hunt_options *opts)` => `(int)`
*/
/**
	...
	freed.
*/
FZ_FUNCTION int ll_fz_propose_table_within_bounds(::fz_stext_page *page, ::fz_rect bounds, ::fz_stext_grid_positions **xposp, ::fz_stext_grid_positions **yposp, const ::fz_table_hunt_options *opts);
...
/**
	...
	information.
*/
FZ_FUNCTION void ll_fz_table_hunt(::fz_stext_page *page, const ::fz_table_hunt_options *opts);
...
*/
FZ_FUNCTION void ll_fz_table_hunt_within_bounds(::fz_stext_page *page, ::fz_rect bounds, const ::fz_table_hunt_options *opts);
...
/** Returns string containing a fz_table_hunt_options's members, labelled and inside (...), using operator<<. */
FZ_FUNCTION std::string to_string_fz_table_hunt_options(const ::fz_table_hunt_options& s);

/** Returns string containing a fz_table_hunt_options's members, labelled and inside (...), using operator<<.
(Convenience overload). */
FZ_FUNCTION std::string to_string(const ::fz_table_hunt_options& s);
...
/** fz_table_hunt_options: writes members, labelled and inside (...), to a stream. */
FZ_FUNCTION std::ostream& operator<< (std::ostream& out, const ::fz_table_hunt_options& rhs);

/** fz_table_hunt_options: comparison function. */
FZ_FUNCTION bool operator==( const ::fz_table_hunt_options& lhs, const ::fz_table_hunt_options& rhs);
