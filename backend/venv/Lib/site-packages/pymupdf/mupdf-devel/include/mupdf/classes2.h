...
namespace mupdf
{
	...
	*/
	...
	/**
		...
		into an already initialised opts structure.
	*/
	FZ_FUNCTION void fz_apply_table_hunt_options(FzTableHuntOptions& opts, const FzOptions& options);
	...
	*/
	...
	/**
		...
		the table.
	*/
	FZ_FUNCTION FzStextBlock fz_find_table_within_bounds(const FzStextPage& page, const FzRect& bounds, FzTableHuntOptions& opts);
	...
	/**
		...
		limit.
	*/
	FZ_FUNCTION FzStextBlock fz_find_table_within_grid(const FzStextPage& page, const FzStextGridPositions& xpos, const FzStextGridPositions& ypos, float limit, FzTableHuntOptions& opts);

	/** Class-aware wrapper for `::fz_find_table_within_grid_dividers()`.  */
	FZ_FUNCTION FzStextBlock fz_find_table_within_grid_dividers(const FzStextPage& page, const std::vector<fz_stext_grid_divider> &xs, const std::vector<fz_stext_grid_divider> &ys, float limit, FzTableHuntOptions& opts);

	/** Class-aware wrapper for `::fz_find_table_within_grid_floats()`.  */
	/** Swig-friendly wrapper for fz_find_table_within_grid(). */
	FZ_FUNCTION FzStextBlock fz_find_table_within_grid_floats(const FzStextPage& page, const std::vector<float> &xs, const std::vector<float> &ys, float limit, FzTableHuntOptions& opts);
	...
	*/
	...
	FZ_FUNCTION void fz_init_table_hunt_options(FzTableHuntOptions& opts);
	...
	*/
	...
	/**
		...
		This initialises the opts structure.
	*/
	FZ_FUNCTION FzTableHuntOptions fz_parse_table_hunt_options(FzTableHuntOptions& opts, const char *args);
	...
	*/
	...
	This function has out-params. Python/C# wrappers look like:
		`fz_propose_table_within_bounds(::fz_stext_page *page, ::fz_rect bounds, ::fz_stext_grid_positions **xposp, ::fz_stext_grid_positions **yposp, const ::fz_table_hunt_options *opts)` => `(int)`
	 */
	/**
		...
		freed.
	*/
	FZ_FUNCTION int fz_propose_table_within_bounds(const FzStextPage& page, const FzRect& bounds, FzStextGridPositions& xposp, FzStextGridPositions& yposp, FzTableHuntOptions& opts);
	...
	*/
	...
	/**
		...
		information.
	*/
	FZ_FUNCTION void fz_table_hunt(const FzStextPage& page, FzTableHuntOptions& opts);
	...
	*/
	FZ_FUNCTION void fz_table_hunt_within_bounds(const FzStextPage& page, const FzRect& bounds, FzTableHuntOptions& opts);
	...
	*/
	...
	FZ_FUNCTION void pdf_clip_page(const PdfPage& page, const FzRect& clip);
